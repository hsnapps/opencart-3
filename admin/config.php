<?php
// HTTP
define('HTTP_SERVER', 'http://opencart.hsn/admin/');
define('HTTP_CATALOG', 'http://opencart.hsn/');

// HTTPS
define('HTTPS_SERVER', 'http://opencart.hsn/admin/');
define('HTTPS_CATALOG', 'http://opencart.hsn/');
